...
function IndividualChart ({chart_id}) {
    ...
    return(
        <Box sx={{display: "flex", width: "100%"}}>
            ...
            <ChangeTitle titleModalOpen={titleModalOpen} setTitleModalOpen={setTitleModalOpen} />
            <ChangeColor colorModalOpen={colorModalOpen} setColorModalOpen={setColorModalOpen}/>
            <ChangeXLabel xLabelModalOpen={xLabelModalOpen} setXLabelModalOpen={setXLabelModalOpen} />
            <ChangeYLabel yLabelModalOpen={yLabelModalOpen} setYLabelModalOpen={setYLabelModalOpen} />
        </Box>
    )
}
